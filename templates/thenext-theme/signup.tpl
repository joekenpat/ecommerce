                ...
                <form method="post" id="register-account-form" action="#" accept-charset="UTF-8">
                    ...
                    <div class="form-group">
                        <div class="input-with-icon-left">
                            ...
                            <input type="text" class="input-text with-border" placeholder="{LANG_PHONE_NO}" value="{PHONE_FIELD}" id="Rphone" name="phone" onBlur="checkAvailabilityPhone()" required />
                        </div>
...
<script>
    ...
    function checkAvailabilityPhone() {
        var $item = $("#Rphone").closest('.form-group');
        $("#loaderIcon").show();
        jQuery.ajax({
            url: "{APP_URL}check_availability.php",
